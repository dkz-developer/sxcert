...
<style type="text/css">
   ...
   <article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<span class="r">共有数据：<strong><?php echo e($count); ?></strong> 条</span>
			</div>
			<div class="mt-20">
					...
					<tbody>
						<?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr class="text-c">
								...
								<td id="blance<?php echo e($val->UserId); ?>"><?php echo e(number_format($val->Balance)); ?></td>
								<td class="f-14 td-manage"><a style="text-decoration:none" onClick="change_money('修改金币',<?php echo e($val->UserId); ?>)" title="是否热门">修改金币</a></td>
							</tr>
