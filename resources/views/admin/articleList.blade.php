    ...
    <article class="cl pd-20">
        <div class="text-c">
            ...
            <select name="" class="select">
                ...
                <option value="{{$val->id}}">{{$val->theme_name}}</option>
                @endforeach
            </select>
            </span>
            日期范围：
                ...
                <tbody>
                  <!--   <tr class="text-c">
                    ...
                    <tr class="text-c">
                        ...
                        <td>{{$val->user_name}}</td>
                        <td class="td-status">@if($val->is_top == 1)<span class="label label-success radius">置顶</span>@else <span class="label label-primary radius">否</span> @endif</td>
                        <td class="td-status">@if($val->is_brilliant == 1)<span class="label label-success radius">精华</span>@else <span class="label label-primary radius">否</span> @endif</td>
                        <td class="f-14 td-manage"><a style="text-decoration:none" onClick="article_shenhe(this,'10001')" href="javascript:;" title="置顶">置顶</a>
                            <a style="text-decoration:none" class="ml-5" onClick="article_edit('资讯编辑','article-add.html','10001')" href="javascript:;" title="加精">加精</a>
                            <a style="text-decoration:none" class="ml-5" onClick="article_del(this,'10001')" href="javascript:;" title="删除">删除</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
