...
<head>
	...
	<title>
		...
		?>-<?php 
			...
			echo !empty($country [1]) ?  $country [1] : '';?>-{{$info->model}}-{{$info->version}}-{{$info->os}}-GSMGOOD - 分享安卓最新鲜最好玩的资源</title>
					...
					<div class="info well well-sm clearfix">
						<div class="left"> 
							<ul>
								...
								<li>资料类型：<a  href="/g?k=<?php  $keyword = explode('/', $info->type); if(isset($keyword [1])) echo urlencode($keyword [1]);?>">{{$keyword [0]}}</a></li>
