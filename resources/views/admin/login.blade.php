		...
		<form class="form form-horizontal" action="javascript:void(0)" method="post" id="loginForm">
			<div class="row cl">
				...
				<div class="formControls col-xs-8">
					<input id="" name="userName" type="text" placeholder="用户名" class="input-text size-L" value="{{ old('userName') }}">
				</div>
			</div>
			{{ csrf_field() }}
			<div class="row cl">
			...
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
					...
					<img src="{{ URL('admin/kit/captcha/1') }}" id="verifyCode" onclick="re_captcha()" style="cursor: pointer;">
