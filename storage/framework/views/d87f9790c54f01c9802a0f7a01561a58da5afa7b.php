	...
	<form class="form form-horizontal" id="form-article-add" action="javascript:void(0)">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" name="brand">
					<?php $__currentLoopData = $brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					 	<option value="<?php echo e($val->name); ?>" <?php if(!empty($info) && $info->brand == $val->name): ?>  selected="seletcted" <?php endif; ?>><?php echo e($val->name); ?></option>
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" name="model">
					<?php $__currentLoopData = $model; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($val->name); ?>" <?php if(!empty($info) && $info->model == $val->name): ?>  selected="seletcted" <?php endif; ?> ><?php echo e($val->name); ?></option>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</select>
				</span> </div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select  class="select" name="os">
					<?php $__currentLoopData = $os; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($val->name); ?>" <?php if(!empty($info) && $info->os == $val->name): ?>  selected="seletcted" <?php endif; ?>><?php echo e($val->name); ?></option>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</select>
				</span> </div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" name="type">
					<?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($val->name); ?>" <?php if(!empty($info) && $info->type == $val->name): ?>  selected="seletcted" <?php endif; ?>><?php echo e($val->name); ?></option>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</select>
				</span> </div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select  class="select" name="country">
					<?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($val->name); ?>" <?php if(!empty($info) && $info->country == $val->name): ?>  selected="seletcted" <?php endif; ?>><?php echo e($val->name); ?></option>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</select>
				</span> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo e(isset($info->version) ? $info->version : ''); ?>" placeholder="" id="" name="version">
			</div>
		</div>
		<!--<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select  class="select" name="tag">
					<?php $__currentLoopData = $tag; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($val->name); ?>" <?php if(!empty($info) && $info->tag == $val->name): ?>  selected="seletcted" <?php endif; ?>><?php echo e($val->name); ?></option>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</select>
				</span> </div>
		</div>-->
		...
		<!--<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo e(isset($info->remarks) ? $info->remarks : ''); ?>" placeholder="" id="" name="remarks">
			</div>
		</div>-->
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>下载地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo e(isset($info->download_url) ? $info->download_url : ''); ?>" placeholder="" id="" name="download_url">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>下载密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo e(isset($info->download_password) ? $info->download_password : ''); ?>" placeholder="" id="" name="download_password">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo e(isset($info->sort) ? $info->sort : 0); ?>" placeholder="" id="" name="sort">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>单价(金币)：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo e(isset($info->price) ? $info->price : ''); ?>" placeholder="" id="" name="price">
			</div>
		</div>
		<?php if(!empty($info) && $info->id): ?>
		...
		<!--<?php if(!empty($info) && $info->cover): ?>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">缩略图：</label>
			<div class="formControls col-xs-8 col-sm-9" style="height: 150px;width: 200px">  
				<img src="<?php echo e(Storage::url($info->cover)); ?>" style="width: 100%;height: 100%">
			</div>
		</div>
		<?php endif; ?>
		<div class="row cl">
		...
		<input type="hidden" name="cover" id="cover" value="<?php echo e(isset($info->cover) ? $info->cover : ''); ?>">-->
		<!--<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<script id="abstract" type="text/plain" style="width:100%;height:400px;"><?php echo isset($info->abstract) ? $info->abstract : ''; ?></script> 
			</div>
		</div>
		<div class="row cl">
