...
@section('content')
   <article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" data-title="添加资讯" _href="article-add.html" onclick="article_add('添加品牌','/admin/commonPage')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加品牌</a>
				</span>
				<span style="text-align: center;font-size: 18px;font-weight: bold;display: inline-block;width: 65%">常用品牌</span>
